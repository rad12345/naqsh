...
class Gump
{
     ...
     * @throws Exception
     */
    public function validate(array $input, array $ruleset,array $usererrors)
    {
        $this->errors = array();
        ...
        return (count($this->errors) > 0) ? $this->errors_array($usererrors,$this->errors) : true;
    }
    ...
    */
    ...
    public function errors_array($errors,$fields){
    
    $error = array();

foreach ($fields as $key=>$value){
$error[] = $errors[$value['field'].$value['rule']];
}
return $error;
    }
} // EOC
